...
export default function InboekBedanktPage() {
  return (
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <FadeIn delay={0.1}>
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-secondary leading-tight mb-6 md:mb-8">
                Aanmelding <span className="text-primary italic">ontvangen!</span>
              </h1>
            </FadeIn>

            <FadeIn delay={0.2}>
              <p className="text-lg md:text-xl lg:text-2xl text-slate-500 mb-8 md:mb-12 leading-relaxed italic">
                Wij nemen binnen 24 uur contact met u op om uw laadinfra en inboekmogelijkheden te bespreken.
              </p>
            </FadeIn>
            ...
            <FadeIn delay={0.3}>
              <div className="bg-slate-50 rounded-[2rem] p-6 md:p-8 border border-slate-100 mb-10 md:mb-12 max-w-xl mx-auto">
                <p className="text-slate-600 font-medium">
                  Liever direct in gesprek? Bel ons op{' '}
            ...
            <FadeIn delay={0.4}>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <span>Lees over ERE-certificaten</span>
